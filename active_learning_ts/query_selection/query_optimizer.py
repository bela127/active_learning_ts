...
class QueryOptimizer(Protocol):
    ...
    # I am not sure the optimizer should know anything about the retrievement Strategy
    ...
    # the oracle calculates the real cost, while here the expected cost of possible candidates is calculated, so it has to be calculated again for each instance
